...
const cardData = [
  {
    ...
    image: 'https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://coursera-course-photos.s3.amazonaws.com/bf/d0c2f03cf211e5a922adc5eaf6c043/MOOC-4.png?auto=format%2Ccompress&dpr=1',
  },
  {
    title: 'Arduino',
...
export default function MediaCard() {
  return (
    ...
    >
      <Typography gutterBottom variant="h5" component="div" sx={{ fontWeight: 700 ,marginBottom:5 }}>
        WorkShops
      </Typography>
